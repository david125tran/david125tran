...
### Tech Skills:  
APIs, BeautifulSoup, Querying Databases, Flask, Git, GitHub, Matplotlib, MySQL, NumPy, Object Oriented Programming (OOP), Pandas, PyCharm, Tableau, Tkinter GUI, Visual Studio Code, Web Scraping
