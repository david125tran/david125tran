...
🧪 Strong background in programming, with hands-on experience managing database servers and robotic automation.  
...
|[JSON-REST-API](https://github.com/david125tran/JSON-REST-API)|![Python](https://img.shields.io/badge/language-Python-blue) ![JSON](https://img.shields.io/badge/JSON-000?logo=json&logoColor=fff)|A REST API app that receives data in JSON format.|
