...
| [**Model-Context-Protocol-MCP**](https://github.com/david125tran/Model-Context-Protocol-MCP) | ![Python](https://img.shields.io/badge/language-Python-blue) ![OpenAI](https://shields.io/badge/-OpenAI-93f6ef?logo=openai) ![MCP](https://img.shields.io/badge/MCP-0A0A0A?style=for-the-badge&logo=openai&logoColor=white) ![FastAPI](https://img.shields.io/badge/FastAPI-009688?style=for-the-badge&logo=fastapi&logoColor=white) ![MySQL](https://img.shields.io/badge/MySQL-4479A1?style=for-the-badge&logo=mysql&logoColor=white) | Local **Model Context Protocol** server + UI allowing natural language queries on a structured MySQL dataset. Converts user questions ➜ safe SQL ➜ structured answers + summaries. Implements defensive AI practices (SQL sanitization, least-privilege DB access, rate-limiting, allowlists) aligned with **OWASP Top 10 for LLMs** to prevent prompt injection & unauthorized model behavior. |
